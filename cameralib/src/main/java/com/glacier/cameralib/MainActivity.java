...
import com.glacier.cameralib.UI.FolderChooserDialog;
import com.glacier.cameralib.UI.MainUI;
...
public class MainActivity extends Activity implements AudioListener.AudioListenerCallback {
    ...
    private void clickedSwitchVideo() {
        if (MyDebug.LOG)
    ...
    private void showPhotoVideoToast(boolean switch_video) {
        ...
        String lock_orientation = sharedPreferences.getString(PreferenceKeys.getLockOrientationPreferenceKey(), "横向");
